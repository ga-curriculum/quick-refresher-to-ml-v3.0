<h1>
  <span class="headline">Introduction to AI Project Design</span>
</h1>
...
*   What decisions are slow, expensive, inconsistent, or manual?
*   What outcomes matter most to the business (revenue, cost, risk, experience)?
*   Where could prediction, generation, or automation improve workflows?
...
**Goal:** Turn a business idea into a structured AI problem.

**Define:**

*   **Objective:** What does success look like?
*   **User:** Who will use the system, and how?
*   **Value:** What financial or operational impact will it create?
*   **Constraints:** Time, compliance, security, and integration needs.

**Output:**

*   A scoped problem statement ready for feasibility analysis.

***

### **Step 3: Assess Data Availability and Readiness**

**Goal:** Determine whether the project is possible with available data.
...
*   A data readiness assessment and gap analysis.

***

### **Step 4: Evaluate Technical Feasibility**

**Goal:** Confirm whether the AI problem can be solved with current technology.
...
### **Step 5: Estimate Business Value and Risk**

**Goal:** Determine whether the project is worth the investment.

**Analyze:**

*   Estimated ROI (revenue increase, cost savings, risk reduction).
*   Impact on customer or employee experience.
*   Legal, regulatory, or reputational risk.
*   Change‑management complexity (training, workflow disruption).
...
### **Step 6: Develop a Minimum Viable Model (MVM)**

**Goal:** Deliver early measurable outcomes.

**Focus on:**

*   Light‑weight prototype or proof‑of‑concept.
*   Testing initial model performance using representative data.
*   Validating assumptions with real users early.

**Output:**

*   Model prototypes and early validation data.

***

### **Step 7: Deployment Planning & Governance**

**Goal:** Ensure the AI solution is responsibly and sustainably deployed.
...
*   A deployment roadmap and governance plan.

***

## AI Project Design Guiding Principles
...
Ask participants to think of one workflow in their daily job that is:
...
This mirrors the ML refresher activity and transitions well into later modules.
